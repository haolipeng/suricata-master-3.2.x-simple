...
CPP = gcc -E
CPPFLAGS = -I/usr/include  -I/usr/local/include -I/usr/local/lib/htp/include
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LIBS = -lmagic -lcap-ng -lhtp -lpcap -lnet -ljansson -lpthread -lyaml -lpcre  -L/usr/local/lib -lhtp
